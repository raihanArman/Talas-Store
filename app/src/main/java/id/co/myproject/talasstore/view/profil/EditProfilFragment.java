...
import id.co.myproject.talasstore.util.ConvertBitmap;
...
public class EditProfilFragment extends Fragment implements ConvertBitmap {
    ...
    Button btnUpdate;
    EditText etNama, etUsername, etAlamat, etNoTelp;
    Bitmap bitmap = null;
...
//        idUser = getIntent().getIntExtra("id_user", 0);
    ...
    private void editProfile() {
        ...
        progressDialog.show();
        Call<Value> editProfilRequest = apiRequest.ediProfilRequest(
                kodeMember,
        ...
        userCall.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                if (response.isSuccessful()){
                    ...
                    etNama.setText(user.getNamaMember());
                    etUsername.setText(user.getUsername());
                    etAlamat.setText(user.getAlamatMember());
                    etNoTelp.setText(user.getNoTelpMember());
